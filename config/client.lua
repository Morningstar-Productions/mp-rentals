return {
    ...
    useTarget = false,
    useOxQwade = false, -- Using Qwadebot's Variation of ox_lib using Search
    ...
    vehSpawnLocations = {
        vehicle = vec4(111.37, -1081.11, 29.19, 341.23),

        aircraft = vec4(-1673.4, -3158.47, 13.99, 331.49),

        boat = vec4(-794.95, -1506.27, 2.08, 107.79),
    },
